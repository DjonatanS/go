...
type CategoryServiceClient interface {
	...
	ListCategories(ctx context.Context, in *ListCategoriesRequest, opts ...grpc.CallOption) (*Categories, error)
}
...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *ListCategoriesRequest, opts ...grpc.CallOption) (*Categories, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Categories)
...
type CategoryServiceServer interface {
	...
	ListCategories(context.Context, *ListCategoriesRequest) (*Categories, error)
...
func (UnimplementedCategoryServiceServer) ListCategories(context.Context, *ListCategoriesRequest) (*Categories, error) {
